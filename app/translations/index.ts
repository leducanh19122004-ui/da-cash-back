...
export interface Translations {
  ...
  // Exchanges
  exchanges: { badge: string; title: string; desc: string; all: string; crypto: string; forex: string; register: string; comingSoon: string; guide: string; rate: string; viewDetails: string; disclaimer: string; };
  // How it works
...
const ko: Translations = {
  ...
  exchanges: { badge: '공식 파트너', title: '지원 거래소', desc: 'DA CASH BACK 파트너 링크를 통해 가입하면 캐시백이 활성화됩니다. 비율은 거래소마다 다릅니다.', all: '전체', crypto: '🔷 암호화폐', forex: '📈 외환', register: '캐시백 받기', comingSoon: '출시 예정', guide: '가이드', rate: '캐시백 비율', viewDetails: '자세히 보기', disclaimer: '⚠️ 캐시백 비율은 각 거래소 정책에 따라 변경될 수 있습니다.' },
...
const th: Translations = {
  ...
  exchanges: { badge: 'พาร์ทเนอร์อย่างเป็นทางการ', title: 'ตลาดที่รองรับ', desc: 'สมัครผ่านลิงก์ DA CASH BACK เพื่อเปิดใช้งานแคชแบ็ก อัตราขึ้นอยู่กับแต่ละตลาดและพาร์ทเนอร์', all: 'ทั้งหมด', crypto: '🔷 คริปโต', forex: '📈 ฟอเร็กซ์', register: 'รับแคชแบ็ก', comingSoon: 'เร็วๆ นี้', guide: 'คู่มือ', rate: 'อัตราแคชแบ็ก', viewDetails: 'ดูรายละเอียด', disclaimer: '⚠️ อัตราแคชแบ็กอาจเปลี่ยนแปลงตามนโยบายของแต่ละตลาด' },
...
export const extraTranslations: Record<Lang, TranslationsExtra> = {
  vi: {
    ...
    testimonials: {
      ...
      subtitle:'Thông tin tài khoản được ẩn danh nhằm bảo vệ quyền riêng tư người dùng.',
      mockLabel:'',
      privacyNote:'Thông tin tài khoản được ẩn danh nhằm bảo vệ quyền riêng tư người dùng.',
      fullNote:'Thông tin tài khoản được ẩn danh nhằm bảo vệ quyền riêng tư.',
  ...
  en: {
    ...
    testimonials: {
      ...
      subtitle:'Account information is anonymized to protect user privacy.',
      mockLabel:'',
      privacyNote:'Account information is anonymized to protect user privacy.',
      fullNote:'Account information is anonymized to protect user privacy.',
  ...
  ko: {
    ...
    testimonials: {
      ...
      subtitle:'계정 정보는 개인정보 보호를 위해 익명 처리됩니다.',
      mockLabel:'',
      privacyNote:'계정 정보는 개인정보 보호를 위해 익명 처리됩니다.',
      fullNote:'계정 정보는 개인정보 보호를 위해 익명 처리됩니다.',
  ...
  th: {
    ...
    testimonials: {
      ...
      subtitle:'ข้อมูลบัญชีถูกปกปิดเพื่อปกป้องความเป็นส่วนตัวของผู้ใช้',
      mockLabel:'',
      privacyNote:'ข้อมูลบัญชีถูกปกปิดเพื่อปกป้องความเป็นส่วนตัวของผู้ใช้',
      fullNote:'ข้อมูลบัญชีถูกปกปิดเพื่อปกป้องความเป็นส่วนตัวของผู้ใช้',
  ...
  id: {
    ...
    testimonials: {
      ...
      subtitle:'Informasi akun dianonimkan untuk melindungi privasi pengguna.',
      mockLabel:'',
      privacyNote:'Informasi akun dianonimkan untuk melindungi privasi pengguna.',
      fullNote:'Informasi akun dianonimkan untuk melindungi privasi pengguna.',
...
export interface MemberPrivilegesTranslations {
  ...
  // 3 main cards
  m1: { icon:string; title:string; sub:string; desc:string; note?:string; };
  m2: { icon:string; title:string; sub:string; desc:string; note?:string; };
...
export const memberPrivilegesTranslations: Record<import('./index').Lang, MemberPrivilegesTranslations> = {
  vi: {
    ...
    title: 'Không chỉ cashback — đây là lợi thế cho trader nghiêm túc',
    subtitle: 'DA Cashback mở ra cộng đồng tín hiệu, đào tạo KOL Crypto và cơ hội phát triển trong hệ sinh thái DA Network.',
  ...
  en: {
    ...
    title: 'More than cashback — this is the edge for serious traders',
    subtitle: 'DA Cashback opens the door to a signal community, KOL Crypto training, and growth opportunities in the DA Network ecosystem.',
  ...
  ko: {
    badge: '✦ 회원 전용 특별 혜택 ✦',
    title: '단순한 캐시백이 아닙니다 — 진지한 트레이더를 위한 경쟁 우위',
    subtitle: 'DA Cashback은 시그널 커뮤니티, KOL 교육, DA Network 생태계 성장 기회를 제공합니다.',
  ...
  th: {
    ...
    title: 'ไม่ใช่แค่แคชแบ็ก — นี่คือข้อได้เปรียบสำหรับ Trader ที่จริงจัง',
    subtitle: 'DA Cashback เปิดประตูสู่ชุมชน Signal, การอบรม KOL Crypto และโอกาสในระบบนิเวศ DA Network',
  ...
  id: {
    ...
    title: 'Lebih dari cashback — ini adalah keunggulan untuk trader serius',
    subtitle: 'DA Cashback membuka komunitas sinyal, pelatihan KOL Crypto, dan peluang berkembang di ekosistem DA Network.',
