...
const ko: Translations = {
  ...
  exchanges: { badge: '공식 파트너', title: '지원 거래소', desc: 'DA CASH BACK 파트너 링크를 통해 가입하면 캐시백이 활성화됩니다. 비율은 거래소마다 다릅니다.', all: '전체', crypto: '🔷 암호화폐', forex: '📈 외환', register: '가입하기', guide: '가이드', rate: '캐시백 비율', viewDetails: '자세히 보기', disclaimer: '⚠️ 캐시백 비율은 각 거래소 정책에 따라 변경될 수 있습니다.' },
...
const th: Translations = {
  ...
  exchanges: { badge: 'พาร์ทเนอร์อย่างเป็นทางการ', title: 'ตลาดที่รองรับ', desc: 'สมัครผ่านลิงก์ DA CASH BACK เพื่อเปิดใช้งานแคชแบ็ก อัตราขึ้นอยู่กับแต่ละตลาดและพาร์ทเนอร์', all: 'ทั้งหมด', crypto: '🔷 คริปโต', forex: '📈 ฟอเร็กซ์', register: 'สมัคร', guide: 'คู่มือ', rate: 'อัตราแคชแบ็ก', viewDetails: 'ดูรายละเอียด', disclaimer: '⚠️ อัตราแคชแบ็กอาจเปลี่ยนแปลงตามนโยบายของแต่ละตลาด' },
