    ...
    <section id="how-it-works" style={{ padding: '6rem 1.5rem', background: 'transparent' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: '1.5rem', position: 'relative' }} className="steps-grid">
          ...
          {steps.map(step => (
            <div key={step.step} style={{ background: '#111111', border: '1px solid rgba(212,175,55,0.2)', borderRadius: '1.25rem', padding: '1.75rem 1.25rem', textAlign: 'center', position: 'relative', transition: 'transform 0.25s ease, border-color 0.25s ease, box-shadow 0.25s ease' }}
