      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', alignItems: 'start' }} className="trust-grid">
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            {points.map((p, i) => (
              <div key={i} style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start', background: 'rgba(8,7,5,0.62)', border: '1px solid rgba(212,175,55,0.15)', borderRadius: '0.875rem', padding: '1rem 1.25rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ background: 'rgba(8,7,5,0.62)', border: '1px solid rgba(212,175,55,0.2)', borderRadius: '1.25rem', padding: '1.5rem' }}>
