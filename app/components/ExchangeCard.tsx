  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        el.style.boxShadow = '0 8px 32px rgba(212,175,55,0.14)';
      }}
      onMouseLeave={e => {
        const el = e.currentTarget;
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '1rem' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          ...
          <div style={{
            ...
            background: `${exchange.color}22`, border: `1.5px solid ${exchange.color}44`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: '0.85rem', fontWeight: 800, color: exchange.color, letterSpacing: '0.02em',
          }}>
            {exchange.initials}
          </div>
          <div>
      ...
      <div style={{
        ...
        borderRadius: '0.75rem', padding: '0.75rem 1rem', marginBottom: '1rem', textAlign: 'center',
      }}>
        <p style={{ fontSize: '0.7rem', color: '#888', marginBottom: '0.2rem' }}>Tỷ lệ hoàn phí</p>
        <p style={{
      ...
      <div style={{ display: 'flex', gap: '0.6rem' }}>
        <a
          ...
          style={{
            flex: 1, padding: '0.6rem', textAlign: 'center', textDecoration: 'none',
            fontWeight: 700, fontSize: '0.85rem',
            background: 'linear-gradient(135deg,#FFD700,#D4AF37,#B8860B)',
            color: '#050505', borderRadius: '0.625rem',
        ...
        <a
          ...
          style={{
            ...
            borderRadius: '0.625rem', transition: 'background 0.2s',
          }}
